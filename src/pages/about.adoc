...
* DSGVO-konform
** Betrieb in einem link:https://docs.hetzner.com/de/general/others/certificates/[ISO/IEC 27001 zertifizierten] Rechenzentrum
** IT-Sicherheitskonzept auf Basis des link:https://www.bsi.bund.de/DE/Themen/Unternehmen-und-Organisationen/Standards-und-Zertifizierung/IT-Grundschutz/it-grundschutz_node.html[BSI IT-Grundschutz]
